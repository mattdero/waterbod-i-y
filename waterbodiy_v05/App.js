        ...
        >
          <View style={styles.menuContainer}>
            <TouchableOpacity 
              ...
              onPress={() => navigateToScreen('CalculatorList')}
            >
              <Text style={styles.menuItemText}>All Calculators</Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
              style={styles.menuItem}
              onPress={() => navigateToScreen('RainCatchment')}
            >
              <Text style={styles.menuItemText}>Rain Catchment</Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
              style={styles.menuItem}
              onPress={() => navigateToScreen('CisternSizing')}
            >
              <Text style={styles.menuItemText}>Cistern Sizing</Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
              style={styles.menuItem}
              onPress={() => navigateToScreen('TankCapacity')}
            >
              <Text style={styles.menuItemText}>Tank Capacity</Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
              style={styles.menuItem}
              onPress={() => navigateToScreen('WaterPressure')}
            >
              <Text style={styles.menuItemText}>Water Pressure</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
